...
are decoded deterministically by `doc_extract.py`) and folded into the prompt as
**advisory context — never a source of figures**. No real client data.

## research/ — upload under "2 · Research documents"
| File | What it is |
| --- | --- |
| `Meridian_CIO_Market_Outlook_Q3_2026.md` | House CIO quarterly outlook & positioning |
...
| File | What it is |
| --- | --- |
| `Client_Email_Kadir_260705.eml` | Client email: preferences, pullback rule, Q4 liquidity event |
| `Client_Review_Meeting_Notes_260703.md` | Review-call notes: objectives, risk, action items |
