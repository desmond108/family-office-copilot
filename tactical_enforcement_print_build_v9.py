...
Run: python3 enforcement_page_build.py
  -> tactical_enforcement_print_v9.svg (color) + tactical_enforcement_print_BW_v9.svg
"""
...
with open("tactical_enforcement_print_v9.svg", "w") as f:
    f.write(build("color"))
with open("tactical_enforcement_print_BW_v9.svg", "w") as f:
    f.write(build("mono"))
print("wrote tactical_enforcement_print_v9.svg (color) + tactical_enforcement_print_BW_v9.svg")
