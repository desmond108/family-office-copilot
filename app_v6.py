"""app.py — the Family Office Copilot (Version 6), driven by the REAL engines.
...
st.set_page_config(page_title="Meridian Family Office Copilot · v6", page_icon="🏛️",
...
with st.sidebar:
    st.markdown("<div class='brand'>Meridian<br><b style='font-size:13px'>Family Office</b>"
                "<span style='font-size:11px;color:#9a3a00;font-weight:700;margin-left:6px'>v6</span>"
...
def render_tactical_summary(items: list[dict]):
    ...
    for typ in ("execution_style", "selection_criteria", "question", "other"):
